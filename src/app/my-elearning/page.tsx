  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">My E-Learning Journey</h1>
          <p className="text-gray-600">Track your progress, explore courses, and achieve your learning goals.</p>
        </div>
